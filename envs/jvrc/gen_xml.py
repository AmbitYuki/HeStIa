...
def builder(export_path):
    ...
    arm_joints = ['R_ELBOW_Y', 'R_WRIST_R', 'R_WRIST_Y',
    ...
    shoulder_joints = ['R_SHOULDER_P', 'R_SHOULDER_R', 'R_SHOULDER_Y', 'R_ELBOW_P',
    ...
    for mot in mjcf_model.actuator.motor:
        if mot.joint.name not in leg_joints + shoulder_joints + waist_joints:
            mot.remove()
    ...
    mjcf_model.equality.add('joint', joint1=arm_joints[2], polycoef='0 0 0 0 0')
    mjcf_model.equality.add('joint', joint1=arm_joints[3], polycoef='-0.523 0 0 0 0')
    mjcf_model.equality.add('joint', joint1=arm_joints[4], polycoef='-0.052 0 0 0 0')
    mjcf_model.equality.add('joint', joint1=arm_joints[5], polycoef='0.169 0 0 0 0')
    mjcf_model.equality.add('joint', joint1=arm_joints[6], polycoef='0 0 0 0 0')
    mjcf_model.equality.add('joint', joint1=arm_joints[7], polycoef='-0.523 0 0 0 0')
