...
class JvrcWalkEnv(mujoco_env.MujocoEnv):
    def __init__(self):
        ...
        path_to_xml_out = '/tmp/mjcf-export/jvrc_walk_waist/jvrc1.xml'
        ...
        # R_SHOULDER_Y R_ELBOW_Y R_WRIST_R R_WRIST_Y
        ...
        self.task._total_duration = 0.25
        self.task._swing_duration = 0.2
        self.task._stance_duration = 0.05
        # call reset
        self.task.reset()
